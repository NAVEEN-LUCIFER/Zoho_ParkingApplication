...
<form action="ServletAdminValidation" method="post">
    <h2 id="greet" style="display:flex; margin-top: 2%; justify-content:center; align-content:center; color:gray;"><strong>WELCOME   TO ADMIN  LOGIN   PAGE!</strong></h2>
