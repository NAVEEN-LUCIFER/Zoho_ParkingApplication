...
@WebServlet(name = "ServletAdminCheckOut", value = "/ServletAdminCheckOut")
public class ServletAdminCheckOut extends HttpServlet {
    @Override
            ...
            try (Connection connection = DriverManager.getConnection(url, user, pass);
                ...
                if (!IsAvail) {
                    ...
                    out.println("<form method=\"get\" action=\"AdminEntry.jsp\">\n" +
                            ...
                            "</form>");
                    RequestDispatcher rs = request.getRequestDispatcher("/AdminExit.jsp");
