...
@WebServlet(name = "ServletAdminValidation", value = "/ServletAdminValidation")
public class ServletAdminValidation extends HttpServlet {
    ...
    public static boolean admin(String uname, String psw) throws SQLException {
        ...
        try {
            PreparedStatement ps = connection.prepareStatement("SELECT userName,pass FROM AdminDB;");
...
//            throw new RuntimeException(e);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (sub != null) {
            try {
                if ((ServletAdminValidation.admin(uname, psw))) {
