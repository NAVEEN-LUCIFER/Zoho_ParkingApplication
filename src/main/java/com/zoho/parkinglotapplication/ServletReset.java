...
public class ServletReset extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try{
            ...
            String park = "DELETE FROM Parking";
            String us = "DELETE FROM Users";

            PreparedStatement st = connection.prepareStatement(del);
            PreparedStatement st1 = connection.prepareStatement(park);
            PreparedStatement st2 = connection.prepareStatement(us);
