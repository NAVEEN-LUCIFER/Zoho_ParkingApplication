...
@WebServlet(name = "ServletAdminCheckIn", value = "/ServletAdminCheckIn")
public class ServletAdminCheckIn extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (LotBlock == null) {
            out.println("<script> alert(\"Enter Lot Correctly\") </script>");
        } else {
            //Loading the  JDBC
...
//                    out.println("TAKE " + LotBlock + " TO PARK YOUR VEHICLE!");
                        out.println("HI " + Name + " Your vehicle is parked at: " + LotBlock + "<br>");
                        out.println("<form method=\"get\" action=\"AdminHome.jsp\">\n" +
                                "    <button id=\"ReturnOpt\" class=\"ReturnOpt\">Return To Home</button>\n" +
                                "</form>");
                        RequestDispatcher rs = request.getRequestDispatcher("/AdminEntry.jsp");
                        rs.include(request, response);
                    } else {
                        out.println("OOPS!, YOUR PREFERRED LOT IS TAKEN, PLEASE CHOOSE ANOTHER LOT.");
                        out.println("<form method=\"get\" action=\"AdminEntry.jsp\">\n" +
