...
<div class="container">
    ...
    <form  method="post" action="Servlet_CheckIN">

        <div class="row" id="name">
            <div class="col">Owner name:</div>
            <div class="col"><input id="OwnerName" type="text" placeholder="Name" name="OwnerName" required></div>
        </div>
        ...
        <div class="row" id="type">
            ...
            <div class="col"><input id="RadioCar" type="radio" value="car"  name="radio">CAR</div>
            <div class="col"><input id="RadioBike" type="radio" value="bike" name="radio">BIKE</div>
        </div>

        <div class="row" id="date">
            <div class="col">Date And Time</div>
            <div class="col"> <input id="EntryTime" type="datetime-local" name="EntryTime" placeholder="yyyy-mm-dd'T'HH:mm"required > </div>
        </div>
