    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try {
            try (Connection connection = DriverManager.getConnection(url, user, pass);
                ...
                if (count == 0) {
                    out.println("Record Not Submitted" + "<br>");
                } else {
                    out.println("Record Stored" + "<br>");
                }
                String fare = GetFare(Number, ExitTime);
                out.println("Please Pay: " + fare + "&nbsp&nbsp and get your key.");
                out.println("<form method=\"get\" action=\"index.jsp\">\n" +
                        "    <button id=\"ReturnOpt\" class=\"ReturnOpt\">Return To Options</button>\n" +
                        "</form>");
...
//     -----------------------------------------------------------------------------------------------------------
    ...
    public String GetFare(String Number, String exit_date) {
        ...
        try {
            ...
            double cost_of_hour_car = 0.84, cost_of_hour_bike = 0.17;
